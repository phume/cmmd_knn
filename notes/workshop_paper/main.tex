...
This reframing resolves a long-standing ambiguity in AML systems, where contextual methods are often deployed without evidence that context is actually informative. Moreover, our disagreement diagnostic can inform active learning systems~\cite{das2024tree}: instances where IF and PNKIF disagree are natural candidates for human review, as they represent cases where contextual judgment is required.
